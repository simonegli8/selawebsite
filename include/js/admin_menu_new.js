$(function() {
  ...
  function r(a) {
    ...
    }).toArray().join(","), c.files = a.length) : a.find(".external").length && (b = u);
    var c = $.extend({}, {title:"", layout_color:"", layout_label:"", types:"", size:"", mtime:"", opts:""}, c), q;
  ...
  function n() {
    var a, b, c = $("#admin_menu"), d = {path:gpBLink + "/Admin/Menu", expires:100};
    if (0 < c.length) {
      a = v("gp_menu_hide") || "";
      a = decodeURIComponent(a);
      var e = $("#gp_curr_menu").val();
      a = a.replace(new RegExp("#" + e + "=\\[[^#=\\]\\[]*\\]", ""), "");
      b = "#" + $("#gp_curr_menu").val() + "=[";
      c.find(".hidechildren > div > .gp_label").each(function(a, c) {
        b += $(c).data("arg") + ",";
      });
      b += "]";
      $.cookie("gp_menu_hide", a + b, d);
    }
    $.cookie("gp_menu_prefs", $("#gp_menu_select_form").serialize(), d);
  }
  function v(a) {
    a += "=";
  ...
  var g = $("#admin_menu"), f = $("#admin_menu_tools"), k = !1, p = !1, l = !1, t = $("#menu_info").html(), u = $("#menu_info_extern").html();
  g.nestedSortable({disableNesting:"no-nest", forcePlaceholderSize:!0, handle:"a.sort", items:"li", opacity:.8, placeholder:"placeholder", tabSize:25, toleranceElement:"> div", listType:"ul", delay:2, stop:function(a, b) {
    var c = b.item, d = c.parent().siblings("div"), e = c.children("div"), c = {cmd:"drag", drag_key:m(e), parent:m(d), prev:m(c.prev().children("div")), hidden:c.closest("#menu_available_list").length};
  ...
  $gp.links.menu_info = function(a) {
    ...
    if (a.ctrlKey) {
      ...
      if (a.shiftKey) {
        ...
        var b = a.index(this), d = 0, e = $(".last_clicked");
